...
contract ERC6551Account is IERC165, IERC1271, IERC6551Account, IERC6551Executable {
    ...
    function isValidSigner(address signer, bytes calldata) override external view virtual returns (bytes4) {
    ...
    function token() override public view virtual returns (uint256, address, uint256) {
